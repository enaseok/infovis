class Scatterplot {
    ...
    update(xVar, yVar, colorVar, useColor, filteredData) {
        console.log(xVar, yVar, colorVar, useColor, filteredData);
        this.xVar = xVar;
        this.yVar = yVar;
        ...
        this.circles = this.container.selectAll("circle")
            ...
            .on("mouseover", (e, d) => {
                this.tooltip.select(".tooltip-inner")
                    .html(`NAME: ${d.NAME}<br/>DIVISION: ${d.DIVISION}<br/>RANKING: ${d.RANKING}<br/>${this.xVar}: ${d[this.xVar]}<br />${this.yVar}: ${d[this.yVar]}`);
        ...
        if (useColor) {
            this.legend
                ...
                .attr("transform", `translate(${this.width + this.margin.left + 10}, ${this.height / 2 - 90})`)
